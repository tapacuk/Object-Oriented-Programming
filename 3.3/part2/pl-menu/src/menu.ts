...
import { EntityContext } from '../../dal-data/src/entityContext.ts';
import { JSONProvider } from '../../dal-data/src/serializers/jsonSerializer.ts';
import type { IDataProvider } from '../../dal-data/src/dataProvider.interface.ts';
import { XMLProvider } from '../../dal-data/src/serializers/xmlSerializer.ts';
import { BinaryProvider } from '../../dal-data/src/serializers/binarySerializer.ts';
import { CustomProvider } from '../../dal-data/src/serializers/customSerializer.ts';
